  ...
  return (
    <Fragment>
      <Container fluid style={{ width: "85%" }}>
        <div className="privacyPolicy ptb--50">
          <h3 className="privacy-title text-center">
            Privacy Policy of EcoSoch Solar Pvt. Ltd.
          </h3>
          <p className="disc">
            EcoSoch Solar Pvt. Ltd. operates the https://ecosoch.com website,
            which provides the SERVICE.
          </p>
          <p className="disc">
            This page is used to inform website visitors regarding our policies
            with the collection, use, and disclosure of Personal Information if
            anyone decided to use our Service, the EcoSoch website.
          </p>
          <p className="disc">
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="solari-title-area-three">
                <span className="pre-title privacy-heads">Cookies </span>
              </div>
            </div>
          </div>
          <p className="disc">
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="solari-title-area-three">
                <span className="pre-title privacy-heads">Security </span>
              </div>
            </div>
          </div>
          <p className="disc">
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="solari-title-area-three">
                <span className="pre-title privacy-heads">Contact Us </span>
              </div>
            </div>
          </div>
          <p className="disc">
